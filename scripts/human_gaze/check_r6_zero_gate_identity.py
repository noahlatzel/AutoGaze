...
"""Check exact generation and rescoring identity for the zero-gated R6 path."""
...
def main():
    ...
    treatment_config.gaze_model_config.recurrent_state_hidden_dim = 192
    ...
    expected_new = {
        "gazing_model.recurrent_state_bias.gate",
        "gazing_model.recurrent_state_bias.state_cell.weight_ih",
        "gazing_model.recurrent_state_bias.state_cell.weight_hh",
        "gazing_model.recurrent_state_bias.state_cell.bias_ih",
        "gazing_model.recurrent_state_bias.state_cell.bias_hh",
        "gazing_model.recurrent_state_bias.action_readout.weight",
    }
    ...
    with torch.inference_mode():
        delattr(model.gazing_model, "recurrent_state_bias")
        ...
        model.gazing_model.recurrent_state_bias = module
    ...
    if not all(equality.values()):
        raise AssertionError(f"Zero-gated R6 path changed behavior: {equality}")
    ...
    report = {
        ...
        "expected_new_parameters": sorted(expected_new),
