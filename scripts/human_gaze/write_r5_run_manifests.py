...
"""Create immutable provenance manifests for R5 treatment runs."""
...
def run_name(base_seed):
    return f"r5_feature_transport_base{base_seed}_seed{base_seed + TRAINING_SEED_OFFSET}"
...
def manifest(base_seed, job_id, task_id, code_commit):
    ...
    return {
        ...
        "arm": "causal_feature_transport_logit_bias",
        "base_seed": base_seed,
        ...
        "hydra_config": "autogaze/configs/av_gaze_stavis_r5_feature_transport.yaml",
        "experiment_config": "experiments/human_gaze/configs/r5_causal_feature_transport.yaml",
        ...
        "learning_rate": 3e-6,
        "schedule": "constant",
        "temporal_position_encoding": "causal_feature_transport_logit_bias",
