...
"""Create immutable provenance manifests for R6 treatment runs."""
...
def run_name(base_seed):
    return f"r6_recurrent_state_base{base_seed}_seed{base_seed + TRAINING_SEED_OFFSET}"
...
def manifest(base_seed, job_id, task_id, code_commit):
    ...
    return {
        ...
        "arm": "selection_conditioned_recurrent_state_logit_bias",
        "base_seed": base_seed,
        ...
        "hydra_config": "autogaze/configs/av_gaze_stavis_r6_recurrent_state.yaml",
        "experiment_config": "experiments/human_gaze/configs/r6_recurrent_trajectory_state.yaml",
